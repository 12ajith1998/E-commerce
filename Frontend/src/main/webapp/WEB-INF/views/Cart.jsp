            ...
            <div class="table-responsive">
                <table class="table table-striped">
                    ...
                    <tbody> 
  					...
  					<form action="<c:url value="/updateCartItem/${CartList.cartId}"/>" method="post">
  						<tr>
  							<td></td>
                            ...
                            <a href="<c:url value="/deleteCartItem/${CartList.cartId}"/>" class="btn btn-sm btn-danger"> Remove</a>
                            </td>
